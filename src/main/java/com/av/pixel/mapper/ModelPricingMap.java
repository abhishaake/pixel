...
public class ModelPricingMap {
    ...
    public static ModelPricingDTO toDTO (ModelPricing modelPricing) {
        ...
        return new ModelPricingDTO()
                ...
                .setTurboRenderPrice(modelPricing.getTurboRenderPrice())
                .setTurboRenderPriceMultiplier(modelPricing.getTurboRenderPriceMultiplier())
                .setQualityRenderPrice(modelPricing.getQualityRenderPrice())
                .setQualityRenderPriceMultiplier(modelPricing.getQualityRenderPriceMultiplier())
